...
import 'package:school_app/pages/class_students_page.dart';
...
class _TeacherPanelState extends State<TeacherPanel> {
  ...
  void _openClassStudents(Map<String, dynamic> classData) {
  Navigator.push(
    context,
    MaterialPageRoute(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => _openClassStudents(classData),
                              tooltip: 'Список учеников',
                            ),
                            IconButton(
                              icon: const Icon(Icons.schedule),
